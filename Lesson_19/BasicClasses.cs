...
namespace MYGIS
{
    ...
    public class GISTools
    {
        ...
        public static List<Object> FindUniqueValues(List<Object> values)
        {
            ...
            {
                if (values[i].Equals(values[i - 1]) == true)
                {
    ...
    public class GISThematic
    {
        ...
        public GISThematic(SHAPETYPE shapetype)
        {
            if (shapetype == SHAPETYPE.point)
            {
                Update(GISTools.GetRandomColor(),
                    GISConst.PointSize, GISTools.GetRandomColor());
            }
            else if(shapetype == SHAPETYPE.line)
            {
                Update(GISTools.GetRandomColor(),
                    GISConst.LineWidth, GISTools.GetRandomColor());
            }
            else if (shapetype == SHAPETYPE.polygon)
            {
                Update(GISTools.GetRandomColor(),
                    GISConst.PolygonBoundaryWidth, GISTools.GetRandomColor());
            }
        }
